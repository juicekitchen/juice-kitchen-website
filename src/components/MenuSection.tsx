...
const menuCategories: MenuCategory[] = [
  ...
  },
  {
    ...
    icon: <Leaf size={20} />,
    items: [
      { name: "Classic Acai Bowl", price: "$14", description: "Almond milk, acai, strawberry & banana base topped with granola, fresh strawberries, banana, coconut flakes & honey" },
      { name: "Very Berry Acai Bowl", price: "$15", description: "Almond milk, acai, blueberry, strawberry & banana base topped with granola, fresh blueberries, strawberries, goji berry & coconut flakes" },
      { name: "Island Acai Bowl", price: "$15", description: "Coconut milk, acai, pineapple, mango & banana base topped with granola, fresh kiwi, mango, pineapple & coconut flakes" },
      { name: "Nutty Acai Bowl", price: "$15", description: "Almond milk, acai, peanut butter, banana & cacao base topped with granola, cacao nibs, peanut butter drizzle & coconut flakes" },
      { name: "Build Your Own Acai Bowl", price: "$14", description: "Choose your base, toppings & extras to create your perfect bowl" },
    ],
  },
  {
    name: "Breakfast",
